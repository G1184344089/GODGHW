    ...
    <div class="layui-body" style="background-color: #e6e6e6">
        ...
        <div style="padding: 15px;">
            ...
            <div style="margin:0;background-color: white">
                <form class="layui-form" action="${ctx}/user/query" method="post">
                ...
                <table class="layui-table" style="">
                    ...
                    <c:forEach items="${page.list}" var="obj">
                        <tr>
                            ...
                            <td>${obj.downloads}</td>
                            <td id="ckeck">${obj.newAppVersion.versionNo}</td>
                            <td>

                                <c:if test="${not empty  obj.newAppVersion.versionNo }">

                                    <a href="${ctx}/user/app/toCheck/${obj.id}">  <button class="layui-btn layui-btn-normal layui-btn-radius"
                                            style="height: 28px;line-height: 28px">审核
                                    </button>
                                    </a>
                                </c:if>
